...
void TaskDevice::setup(void)
{
    ...
    ledcAttach(MOTOR_FRONT_LEFT_PIN, MOTOR_PWM_FREQ, MOTOR_PWM_RESOLUTION);
    ledcAttach(MOTOR_FRONT_RIGHT_PIN, MOTOR_PWM_FREQ, MOTOR_PWM_RESOLUTION);
    ledcAttach(MOTOR_BACK_LEFT_PIN, MOTOR_PWM_FREQ, MOTOR_PWM_RESOLUTION);
    ledcAttach(MOTOR_BACK_RIGHT_PIN, MOTOR_PWM_FREQ, MOTOR_PWM_RESOLUTION);
