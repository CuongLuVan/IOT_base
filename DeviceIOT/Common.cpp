...
String getInfoDevice(InfoSensor sensorValue, InfoDeviceControl statusDevice)
{
    ...
    String vaString = String(sensorValue.valueHumi) + "," + String(sensorValue.valueTemp) + "," + String(sensorValue.valueDust) + "," + String(sensorValue.valueDust_PM2_5) + "," + String(sensorValue.valueDust_PM10) + "," + String(sensorValue.valueDust_PM1) + "," + String(sensorValue.valueControl) + "," + String(sensorValue.waterLevel) + "," + String(sensorValue.waterLow ? 1 : 0);
